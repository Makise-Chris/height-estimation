...
mtxR, distR, grayL.shape[::-1], criteria = criteria, flags = flags)
    ...
    param_file.write('projMtxL', projMtxL)
    param_file.write('projMtxR', projMtxR)
    param_file.write('calibrateMtxL', newCameraMtxL)
    param_file.write('calibrateMtxR', newCameraMtxR)
    param_file.write('distL', distL)
    param_file.write('distR', distR)
    param_file.write('rot', rot)
    param_file.write('trans', trans)
    print(retStereo)

calibrate('./test_images/stereoLeft', './test_images/stereoRight', 'image', 'png', 24, 8, 6)